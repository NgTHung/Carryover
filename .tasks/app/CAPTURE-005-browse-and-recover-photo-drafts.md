...
CAPTURE-004 is Done. Implementation is in progress, with native iPhone verification pending in [the draft inbox verification record](../../docs/build/draft-inbox.md). The plan reuses the existing editor for partial saves, completion, and confirmed soft deletion; notification scheduling remains in CAPTURE-006.
