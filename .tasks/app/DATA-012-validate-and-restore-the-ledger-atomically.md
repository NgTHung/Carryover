...
- [ ] Successful restore refreshes database reads, draft notification state, and the existing snapshot publication path; absent photo files leave explicit unavailable images.
