...
- [ ] The two fixed accounts are editable from the app; categories and transactions are creatable, editable, and soft-deletable. UI-020 and UI-024 complete the missing controls.
